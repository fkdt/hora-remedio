...
public class MainActivity_bac extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToolbarBottom.findViewById(R.id.iv_settings).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(MainActivity_bac.this, "Settings pressed", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        /*
    public List<Remedio> getSetCarList(int qtd){
        ...
        List<Remedio> listAux = new ArrayList<>();
        */

        /*
        for(int i = 0; i < qtd; i++){
            Remedio c = new Remedio( models[i % models.length], brands[ i % brands.length ], photos[i % models.length] );
            listAux.add(c);
        }
        return(listAux);
    }
